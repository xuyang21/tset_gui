...
class SerialSvmGui(QtWidgets.QWidget, Ui_Form):
    def __init__(self):
        ...
        # self.progressBar_lifetime_remain.setValue(int(lifetime_remain_percent))
        #
    ...
    def port_open(self):
        ...
        if status:
            ...
            self.groupBox_4.setTitle(self.com.portName() + " : OPEN")
        else:
    ...
    def port_close(self):
        try:
            ...
            pass
        if self.com.portName() != "":
            self.groupBox_4.setTitle(self.com.portName() + " : CLOSED")

    def start_measure(self):
        if self.com.portName() == "":
            QMessageBox.critical(self, "Port Error", "串口未连接！")
            return None
    ...
    def svm_eval(self):
        ...
        # byteH_sof2 = (sof2_concentration * 10) // 256
        # send_data.append(dec_to_binary_hex_char(byteH_sof2))
        # byteL_sof2 = (sof2_concentration * 10) % 256
